...
import (
	database "github.com/Rishabhcodes65536/GO_JWT/database"
	helper "github.com/Rishabhcodes65536/GO_JWT/helpers"
	"context"
	"fmt"
	"log"
	"net/http"
	...
	"github.com/Rishabhcodes65536/GO_JWT/models"
...
func Login() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		c.JSON(200,gin.H{"token":token,"refreshToken":refreshToken,"user":foundUser})
